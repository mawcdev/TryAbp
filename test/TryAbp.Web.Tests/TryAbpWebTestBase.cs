...
{
    public abstract class TryAbpWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TryAbpWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TryAbpWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TryAbpDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TryAbpDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TryAbpDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TryAbpDbContext, Task<T>> func)
        {
            T result;
